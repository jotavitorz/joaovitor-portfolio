...
export function Header(){
    return (
        <header className="h-0 w-full sticky top-5 z-50 px-2">
            <div className="bg-white/30 backdrop-blur-md text-white h-[68px] max-w-6xl flex flex-col justify-center sm:justify-between items-center rounded-3xl m-auto font-medium shadow-md md:flex-row">
                
                <Link to="/">
                    <h1 className="text-[22px] sm:text-3xl md:pl-20">João Vitor</h1>
                </Link>

                <nav className="text-lg sm:text-xl md:pr-20 select-none">
