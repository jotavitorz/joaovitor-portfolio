...
export function Header(){
    return (
        <header className="sticky top-4 z-50 bg-white/30 backdrop-blur-md text-neutral-800 h-16 max-w-6xl flex justify-between items-center rounded-3xl m-auto font-medium select-none shadow-md">
